...
<div class="container-fluid">
		...
		<form method="POST" action="logout.php" class="d-flex justify-content-end" >
			<input type="submit" name="" value="Cerrar sesion" class="btn btn-outline-danger border-2 mt-5 me-5">
		</form>
  ...
  <div class="col ">
    <div class="card m-5 ">
    	...
    	<div class="divider"></div>
	    	  ...
	    	  <img src="./Imagenes/Empleados/Empleado.png" class="img-fluid rounded-cube " title='Empleados'style="width: 100% ; height:400px; ">
...
<!--buses -->
   <div class="col ">
    <div class="card m-5 text-center ">
    	<h5 class="card-title text-center p-3">BUSES</h5>
    	<div class="divider"></div>
    	
         <img src="./Imagenes/buses/buses.png" class="img-fluid rounded-cube m-4 px-4 text-center" title='buses' style="width: 90% ; height: 350px; ">
      <div class="card-body text-center">
        <p class="card-text "><strong> AQUI PUEDES AGREGAR Y MODIFICAR BUSES </strong></p>
        <button type="button" class="btn btn-primary m-3" data-bs-toggle="modal" data-bs-target="#modalAgregarbuses">Agregar</button>

        	<!-- Modal Agregar buses-->
				<div class="modal fade" id="modalAgregarbuses" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				  <div class="modal-dialog">
				    <div class="modal-content">
				      <div class="modal-header">
				        <h5 class="modal-title col-11 text-center" id="exampleModalLabel">AGREGAR BUSES</h5>
				        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				      </div>
				      <div class="modal-body">
		<form class="" action="./Consultas/Agregarbuses.php" method="POST">
        <div class="p-2 m-2">
        ...
        <button type="submit" name="Enviar" value="Enviar" class="btn btn-primary m-4 w-50">Enviar</button>
        	...
        	<button type="button" class="btn btn-success m-3" data-bs-toggle="modal" data-bs-target="#modalModificarbuses">Modificar</button>
        						
				<div class="modal fade" id="modalModificarbuses" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				  <div class="modal-dialog modal-lg">
				    <div class="modal-content">
				      <div class="modal-header ">
				        <h5 class="modal-title col-11 text-center" id="exampleModalLabel">MODIFICAR buses</h5>
				        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				      </div>
				      <div class="modal-body">
						...
						require_once('./consultas/Selectbuses.php');
						...
						?>
				      	...
				      	<table class="table table-bordered" >
								...
								<tr>
									...
									<td> <?php echo $buses[ 'Marca']  ?></td> 
									<td> <?php echo $buses[ 'Modelo']  ?></td> 	
									<td> <?php echo $buses[ 'Placa']  ?></td> 	
									<td> <?php echo $buses[ 'Color']  ?></td> 	
									
									
									<td>
								                     <a href="./Consultas/Eliminarbuses.php?accion=<?php echo $buses['Placa']; ?>"
								                        >        
								                        <i class="fas fa-trash-alt text-danger"> Eliminar</i>
								                    </a>
								    </td>
								                ...
								                <td>
								                    <a href="./Consultas/Editarbuses.php?accion=<?php echo $buses['Placa']; ?>">
  ...
  <div class="col ">
    <div class="card m-5 text-center ">
    	...
    	<div class="divider"></div>
         ...
         <img src="./Imagenes/Rutas/Ruta.png" claube m-4" title='RUtas'style="width: 90% ; height: 350px; ">
      <div class="card-body text-center">
	...
	<form class="" action="./Consultas/AgregarRutas.php" method="POST">
        ...
        <div class="p-2 m-2">
            ...
            <input type="text" name="Nombre" class="form-control  text-center" id="exampleInputEmail1" aria-describedby="emailHelp" required="true" placeholder="Ejemplo: Concepción">
        </div>
        <div class="p-2 m-2">
  ...
  <div class="col ">
    <div class="card m-5 text-center ">
    	...
    	<a href="RecursosAdmin/Estadisticas.php">
         <img src="./Imagenes/Estadisticas/estadistica.png" claube m-4" title='Estadisticas'style="width: 70% ; height: 350px; "></a>
      <div class="card-body text-center">
        <p class="card-text "><strong> AQUI PUEDES AGREGAR Y MODIFICAR RUTAS </strong></p>
						...
						?>
				      	...
				      	<table class="table table-bordered" >
								...
								<tr>
									...
									<td> <!-- <?php echo $buses[ 'Marca']  ?> --> Concepción</td> 
									<td> 15<!-- <?php echo $buses[ 'Modelo']  ?> --></td> 	
									<td> 50.000<!-- <?php echo $buses[ 'Placa']  ?> --></td> 	
									<td> Enero<!-- <?php echo $buses[ 'Color']  ?> --></td> 	
									<td> 750.000<!-- <?php echo $buses[ 'Color']  ?> --></td> 	
									</tr>
									<!-- <?php endforeach; ?>  -->
